            ...
            <div class="bg-opacity-25 backdrop-blur bg-white/30 rounded shadow-2xl ">
              <div class="flex justify-center">
               <form class="flex bg-white items-center mr-12 mt-12">
                  ...
                  <button class="ml-32 font-rale bg-violet-50 hover:bg-green-200 text-violet-700 text-xl font-semibold  py-3 px-7" @click="submitFile()">
                  Загрузить  
                  </button>
               </form>
               </div>
        ...
        <div class="px-64">
            <div class="h-screen -mt-1 px-3 bg-opacity-25 backdrop-blur bg-white/30 rounded shadow-2xl">
              <div class="container w-3/4">
                  ...
                  <div class="mt-4 border-r border-b border-l w-full mr-2 shadow-xl hover:shadow-2xl border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                    <div class="mb-8">
